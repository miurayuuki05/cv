...
<body>
    <header class="w-[100%] flex justify-evenly">
        <div class="mt-10">
            <h1 class="text-2xl">Faiz CV</h1>
        </div>
        <ul class="mt-10">
            <li><a href="login.php" class="hover:bg-gray-700 text-black hover:text-white duration border px-2 duration-200">Login</a></li>
        </ul>
    </header>

    <div class="mt-24 mx-10 border-4 rounded-xl mb-5">
        ...
        <p class="text-grey-600 text-md m-3"><?php echo $keterampilan; ?></p>
